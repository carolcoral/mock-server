...
export default {
  ...
  project: {
    ...
    importConflictTitle: '{count} APIs have the same path but different response body',
    importConflictHint: 'The following APIs already exist with the same path & method, but the imported response body is different. Please choose which ones to overwrite:',
