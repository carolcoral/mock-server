# PostIssueImageAssetUploadURL

## 原始 Swagger
https://api.cnb.cool/#/operations/PostIssueImageAssetUploadURL

## 接口描述
新增一个 Issue 图片的上传 url 用于上传新建 Issue 的图片。
## 接口权限
repo-issue:rw
## 请求信息
...
**请求地址：** ${CNB_API_ENDPOINT}/{repo}/-/issues/asset-groups/{asset_group_id}/image-asset-upload-url
...
curl -w '%header{traceparent}' -X POST \
  "${CNB_API_ENDPOINT}/{repo}/-/issues/asset-groups/{asset_group_id}/image-asset-upload-url" \
