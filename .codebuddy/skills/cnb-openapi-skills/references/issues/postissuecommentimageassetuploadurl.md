# PostIssueCommentImageAssetUploadURL

## 原始 Swagger
https://api.cnb.cool/#/operations/PostIssueCommentImageAssetUploadURL
...
**请求地址：** ${CNB_API_ENDPOINT}/{repo}/-/issues/{number}/comment-image-asset-upload-url
...
curl -w '%header{traceparent}' -X POST \
  "${CNB_API_ENDPOINT}/{repo}/-/issues/{number}/comment-image-asset-upload-url" \
