# ListRepoInvisibleProperties

## 原始 Swagger
https://api.cnb.cool/#/operations/ListRepoInvisibleProperties
...
**请求地址：** ${CNB_API_ENDPOINT}/{repo}/-/property/invisible
...
curl -w '%header{traceparent}' -X GET \
  "${CNB_API_ENDPOINT}/{repo}/-/property/invisible" \
