...
## 原始 Swagger
https://api.cnb.cool/#/operations/ListInheritMembersOfRepo
...
**请求地址：** ${CNB_API_ENDPOINT}/{repo}/-/inherit-members
...
| role | 字符串 | 否| Role，枚举值：Guest, Reporter, Developer, Master, Owner|
...
curl -w '%header{traceparent}' -X GET \
  "${CNB_API_ENDPOINT}/{repo}/-/inherit-members" \
