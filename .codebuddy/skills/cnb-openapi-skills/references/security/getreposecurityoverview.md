...
| 参数名 | 类型 | 必填 | 描述 |
|--------|------|------|------|
| types | 字符串 | 否| 类型，多个类型用逗号分隔code_sensitive,code_vulnerability,code_issue,code_license 为空默认查询所有类型|
...
```json
{
  ...
  "risk_cnt": {
    ...
    "code_sbom_enable": false, // 是否开启代码 SBOM 扫描
