...
## 原始 Swagger
https://api.cnb.cool/#/operations/GetRepoAnnualRank
...
**请求地址：** ${CNB_API_ENDPOINT}/ranks/repo/annual
...
| year | 字符串 | 否| 年榜年份，格式为2006，不填默认为本年|
| topN | 整数 | 否| 排行前n名|
## 响应信息
...
curl -w '%header{traceparent}' -X GET \
  "${CNB_API_ENDPOINT}/ranks/repo/annual" \
