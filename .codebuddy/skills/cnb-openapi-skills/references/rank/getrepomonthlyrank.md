...
## 原始 Swagger
https://api.cnb.cool/#/operations/GetRepoMonthlyRank
...
**请求地址：** ${CNB_API_ENDPOINT}/ranks/repo/monthly
...
| month | 字符串 | 否| 月榜月份，格式为200601，不填默认为本月|
| topN | 整数 | 否| 排行前n名|
## 响应信息
...
curl -w '%header{traceparent}' -X GET \
  "${CNB_API_ENDPOINT}/ranks/repo/monthly" \
