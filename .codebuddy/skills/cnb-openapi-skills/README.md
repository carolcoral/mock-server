> 💡 **推荐使用 [cnb-skill](https://cnb.cool/cnb/skills/cnb-skill)** — CNB 平台官方技能包，提供更强大的 API 交互能力。

[![Version](https://img.shields.io/badge/version-1.22.12-blue)](https://api.cnb.cool)
