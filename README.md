...
<p align="center">
  HTTP / WebSocket Mock · 多项目隔离 · 权限分级 · 动态代码编译 · 多语言国际化 · 邮件通知 · 系统监控
</p>
...
| 🧬 **代码模板** | Monaco Editor · 编译验证 · 项目级 + 系统级模板 · 热加载 |
| ✉️ **邮件系统** | SMTP 配置 · 模板管理（通用 / 验证码 / 告警）· HTML 实时预览 · 注册验证码 |
| 🌍 **国际化** | 中文 / English / 日本語 · 全站实时切换 |
| 📊 **监控面板** | 请求趋势 + IOPS · CPU / 内存 / 磁盘 · JVM 堆详情 |
| 🎨 **现代 UI** | 深色渐变侧边栏 · Canvas 动态线条 · 分组折叠菜单 · 收缩模式 |
